...
# Finding best hyperparameters for classification task on Pima Indian Diabetes dataset
...
model7 = GridSearchCV(estimator=SVC(), param_grid=param_grid7, scoring='accuracy', refit=True, verbose=3, n_jobs=-1, cv= 5)
model7.fit(X, y)
